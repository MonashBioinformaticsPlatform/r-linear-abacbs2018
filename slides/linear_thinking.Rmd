...
>* Starting point for more advanced statistics
>* A core feature of R
>* Many Bioconductor packages assume users are familiar with linear models
...
Can consider gene expression (and other "high-throughput" measurements) either as a responses to a treatment or as predictors of an outcome.
